...
<section id="container" class="">
              ...
              <div class="col-lg-12">
                <form class="form-horizontal">
                  ...
                  <section class="panel">
                    ...
                    <svg id="seatingLayout" onclick="createSeat(evt, '<?php echo $classCode; ?>')" width="1500" height="1500">
    ...
    function createSeat(evt, classCode){
        ...
        if(columns<=0||rows<=0){
            ...
            var x = evt.clientX - dim.left-70;
            var y = evt.clientY - dim.top-70;
            ...
            var counter = 1;
                ...
                $.ajax({
                    ...
                    success: function(resp) { 
                        for(var i=1;i<=rows;i++){
                            for(var j=1;j<=columns;j++){
                                draw.circle(10).attr({id: (recent_x+(j*70))*(recent_y+(i*70)), fill: 'red', cx: x+(j*70), cy: y+(i*70), r:30});
                            }
                        }
